...
function SidePane() {
    ...
    return (
        <div className="h-full flex  ">
            ...
            <div onDrag={handleDrag} onDragEnd={handleDragEnd} className="w-1 border-r-2 cursor-ew-resize h-full bg-zinc-950 border-zinc-950  hover:border-neutral-400"></div>
